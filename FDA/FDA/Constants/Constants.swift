...
let kMessageValidatePasswordComplexity = "Password should have minimum of 1 special character, 1 upper case letter, 1 lower case letter, 1 numeric number and length(8 - 16) characters"

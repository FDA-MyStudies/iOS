...
let kMessageValidatePasswordComplexity = "Password should have minimum of 1 special character, 1 upper case letter,1 numeric number and length(9 - 16) characters"
